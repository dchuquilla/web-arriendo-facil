  ...
  <div class="af-guest-profile-container">
    <section class="af-guest-profile-card">
      ...
      <p class="af-guest-profile-lead">
        <?php esc_html_e('Este formulario se habilita con un enlace seguro con token. Primero validamos tu enlace y luego puedes enviar tu informacion legal.', 'twentytwentyfive-child'); ?>
      </p>
      ...
      <form id="af-guest-profile-form" class="af-guest-profile-form" enctype="multipart/form-data" novalidate>
        ...
        <div class="af-guest-profile-grid">
          ...
          <div class="af-guest-profile-field">
            <label for="af-gp-rental-years"><?php esc_html_e('Anos de arriendo', 'twentytwentyfive-child'); ?> *</label>
          ...
          <div class="af-guest-profile-field">
            <label for="af-gp-phone"><?php esc_html_e('Telefono (10 digitos)', 'twentytwentyfive-child'); ?></label>
            <input type="tel" id="af-gp-phone" name="phone" inputmode="numeric" pattern="[0-9]{10}" maxlength="10">
          </div>

          <div class="af-guest-profile-field">
            <label for="af-gp-id-number"><?php esc_html_e('Cedula (10 digitos)', 'twentytwentyfive-child'); ?></label>
          ...
          <div class="af-guest-profile-field">
            ...
            <input type="text" id="af-gp-mascotas" name="mascotas" placeholder="Ej: 1 perro pequeno">
          </div>

          <div class="af-guest-profile-field is-full">
            <label for="af-gp-personas"><?php esc_html_e('Personas que viviran', 'twentytwentyfive-child'); ?></label>
            <textarea id="af-gp-personas" name="personas_viviran"></textarea>
          </div>

          <div class="af-guest-profile-field is-full">
            <label for="af-gp-guarantee"><?php esc_html_e('Garantia / respaldo', 'twentytwentyfive-child'); ?></label>
          ...
          <div class="af-guest-profile-field">
            <label for="af-gp-ref1-phone"><?php esc_html_e('Referencia 1 - Telefono', 'twentytwentyfive-child'); ?></label>
          ...
          <div class="af-guest-profile-field">
            <label for="af-gp-ref2-phone"><?php esc_html_e('Referencia 2 - Telefono', 'twentytwentyfive-child'); ?></label>
            <input type="tel" id="af-gp-ref2-phone" name="reference_2_phone" inputmode="numeric" pattern="[0-9]{10}" maxlength="10">
          </div>

          <div class="af-guest-profile-field">
            <label for="af-gp-doc-garantia"><?php esc_html_e('PDF garantia/alicuota', 'twentytwentyfive-child'); ?></label>
            <input type="file" id="af-gp-doc-garantia" name="guest_garantia_alicuota_pdf" accept="application/pdf">
          </div>

          <div class="af-guest-profile-field">
            <label for="af-gp-doc-cedula"><?php esc_html_e('PDF cedula/papeleta', 'twentytwentyfive-child'); ?></label>
        ...
        <p class="af-guest-profile-note">
          <?php esc_html_e('Guardado temporal activo en este navegador para evitar perdida de datos.', 'twentytwentyfive-child'); ?>
        </p>
